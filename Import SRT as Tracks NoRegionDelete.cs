/*
	It creates a new Track, and imports subtitles from *.srt to Sony Vegas with TextEvents.
	Note:
	- the imported TextEvents will not be quantized to frame boundaries (they will remain at the same Timecode as they were originally in the *.srt file)
*/
